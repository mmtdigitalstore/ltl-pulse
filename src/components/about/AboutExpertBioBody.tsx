...
export interface AboutExpertBioBodyProps {
  id: ExpertId;
  displayName: string;
  role: string;
  lane: string;
...
export function AboutExpertBioBody({
  id,
  displayName,
  role,
  lane,
  ...
  return (
    <div className={cn("space-y-5", className)}>
          ...
          <div className="flex flex-wrap items-start gap-x-3 gap-y-1">
            ...
            {socialUrl ? (
              <a
                ...
                className="mt-1 inline-flex size-8 shrink-0 items-center justify-center rounded-md text-ltl-text-secondary transition hover:bg-ltl-border/40 hover:text-ltl-accent"
              >
      ...
      <div className="text-sm font-medium leading-relaxed text-ltl-text-primary md:text-base">
        {positioning}
      </div>

      <div className="space-y-4 border-t border-ltl-border pt-5 text-sm leading-relaxed text-ltl-text-secondary md:text-base">
      ...
      <div className="flex flex-col gap-3 border-t border-ltl-border pt-5 sm:flex-row sm:flex-wrap sm:items-center">
        <Link
